...
sweets = {'печенье': [{'shop': 'ашан', 'price': 10.99}, {'shop': 'пятерочка', 'price': 9.99}, {'shop': 'магнит', 'price': 11.99}],
...
print(sweets['печенье'][:2])
print(sweets['конфеты'][1:3])
print(sweets['карамель'][:3:2])
print(sweets['пирожное'][1:3])